        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                {                                        
                    ...
                    Response.Cookies.Append("Token", businessLogicRequestResponse.JwtTokenStr, option);                    
                    Response.Cookies.Append("Information", businessLogicRequestResponse.RelevantDto.ToString(), option);
                    ...
                    //Response.Cookies.Append("Name", response.FirstName, option);
                    ...
                    authProperties.SetParameter("sadik", "guzel");
                ...
                else
                {
                    ...
                    return new RedirectResult("Account/Login?ReturnUrl=%2F");                    
                }
            }
            catch (Exception e)
            {
