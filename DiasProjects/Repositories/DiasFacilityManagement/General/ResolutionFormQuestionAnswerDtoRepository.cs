...
{
    public class ResolutionFormQuestionAnswerDtoRepository : DevelopmentRepositoryInterface.IResolutionFormQuestionAnswerDtoRepository
    {
        private IBaseResolutionFormQuestionAnswerBusinessRules _baseResolutionFormQuestionAnswerBusinessRules;
        private ApplicationBusinessLogicEnvironment _applicationBusinessLogicEnvironment;
        private IGenericStandartBusinessRules<ResolutionFormQuestionAnswerDto, ResolutionFormQuestionAnswerProfile> _genericStandartBusinessRules;
        private bool businessLogicContainerStatus { get; set; }
        public ResolutionFormQuestionAnswerDtoRepository(
            IBaseResolutionFormQuestionAnswerBusinessRules baseResolutionFormQuestionAnswerBusinessRules, 
            ApplicationBusinessLogicEnvironment applicationBusinessLogicEnvironment,
            IGenericStandartBusinessRules<ResolutionFormQuestionAnswerDto, ResolutionFormQuestionAnswerProfile> genericStandartBusinessRules
            )
        {
            ...
            {
                _baseResolutionFormQuestionAnswerBusinessRules = baseResolutionFormQuestionAnswerBusinessRules;
        ...
        public async Task<Tuple<BusinessLogicMessageCodes.ErrorCodes, IEnumerable<ResolutionFormQuestionAnswerDto>>> GetAllAsync()
        {
            if (businessLogicContainerStatus)
            {
                switch (_applicationBusinessLogicEnvironment)
                {
                    ...
                    case ApplicationBusinessLogicEnvironment.Test:
                        {
                            return new Tuple<ErrorCodes, IEnumerable<ResolutionFormQuestionAnswerDto>>(ErrorCodes.UnknownError, null);
                        }
        ...
        public async Task<Tuple<BusinessLogicMessageCodes.ErrorCodes, ResolutionFormQuestionAnswerDto>> DeleteFromIntAsync(int id)
        {
            if (businessLogicContainerStatus)
            {
                switch (_applicationBusinessLogicEnvironment)
                {
                    ...
                    case ApplicationBusinessLogicEnvironment.Test:
                        {
                            return new Tuple<ErrorCodes, ResolutionFormQuestionAnswerDto>(ErrorCodes.UnknownError, null);
                        }
                    case ApplicationBusinessLogicEnvironment.Live:
                        {
                            return new Tuple<ErrorCodes, ResolutionFormQuestionAnswerDto>(ErrorCodes.UnknownError, null);
        ...
        public async Task<Tuple<BusinessLogicMessageCodes.ErrorCodes, ResolutionFormQuestionAnswerDto>> GetByIdFromIntAsync(int id)
        {
            if (businessLogicContainerStatus)
            {
                switch (_applicationBusinessLogicEnvironment)
        ...
        public async Task<Tuple<BusinessLogicMessageCodes.ErrorCodes, ResolutionFormQuestionAnswerDto>> InsertAsync(ResolutionFormQuestionAnswerDto insertedDto)
        {
            if (businessLogicContainerStatus)
            {
                switch (_applicationBusinessLogicEnvironment)
        ...
        public async Task<Tuple<BusinessLogicMessageCodes.ErrorCodes, ResolutionFormQuestionAnswerDto>> UpdateAsync(ResolutionFormQuestionAnswerDto updatedDto)
        {
            if (businessLogicContainerStatus)
            {
                switch (_applicationBusinessLogicEnvironment)
