...
namespace DiasWebApi.Repositories.DiasFacilityManagement
{
    public class PeriodicTicketWrapperDtoRepository : IPeriodicTicketWrapperDtoRepository
    {
        ...
        public async Task<Tuple<Error, DevExpressLoadResultDto<IEnumerable<CustomPeriodicTicketDto>>>> GetAllPeriodicTicketsWrapperAsync(DevExpressRequest devExpressRequestObj)
        {
            if (businessLogicContainerStatus)
            {
                switch (_applicationBusinessLogicEnvironment)
                {
                    ...
                    case ApplicationBusinessLogicEnvironment.Test:
                        {
                            return new Tuple<Error, DevExpressLoadResultDto<IEnumerable<CustomPeriodicTicketDto>>>(Errors.General.NotFoundDatabaseServer(), null);
                        }
            ...
            {
                return new Tuple<Error, DevExpressLoadResultDto<IEnumerable<CustomPeriodicTicketDto>>>(Errors.General.GeneralServerError(), null);
            }
        }
