                    ...
                    case ApplicationBusinessLogicEnvironment.Development:
                        {
                            ...
                            {
                                redisKey = redisCacheKeyHeader +
                                            RedisDtoDefinitions.CustomTicketReasonLastNodeFind.GetDisplayOrValueFromEnum<RedisDtoDefinitions>() +
                                              "_" + hierarchyId;                                
                            ...
                            Tuple<Error, IEnumerable<CustomTicketReasonCategoryDto>> businessRuleResult = await businessRule.GetTicketReasonCategoryWrapperLastNodeByIdAsync(hierarchyId);
                            ...
                            if (businessRuleResult.Item1.BusinessOperationSucceed && (!(String.IsNullOrEmpty(redisCacheKeyHeader))))
                            {
                                ...
                                {
                                    await RedisCacheOperations<CustomTicketReasonCategoryDto>.SetCacheList(_redisCache, redisKey,
                                                    businessRuleResult.Item2, RedisCacheConstants.customTicketReasonLastNodeFindRedisCacheEntryOptions);
                                }
                                catch (Exception)
                                {
                                }
                    ...
                    case ApplicationBusinessLogicEnvironment.Development:
                        {
                            ...
                            if (businessRuleResult.Item1.BusinessOperationSucceed)
                            {
                                ...
                                RedisCacheOperationExtensions k = new RedisCacheOperationExtensions("127.0.0.1:6379", "*TicketReason*");
                            }
