...
namespace DiasWebApi.Repositories.DiasFacilityManagement
{
    public class TicketWrapperDtoRepository : ITicketWrapperDtoRepository
    {
        ...
        #region Development
        public async Task<Tuple<Error, DevExpressLoadResultDto<IEnumerable<CustomTicketDto>>>> GetAllTicketWrapperAsync(DevExpressRequest devExpressRequestObj,string token)
        {
            if (businessLogicContainerStatus)
            {
                    ...
                    case ApplicationBusinessLogicEnvironment.Development:
                        {
                            ...
                            return await businessRule.GetAllTicketsWrapperAsync(devExpressRequestObj,token);
                        }
            ...
            {
                return new Tuple<Error, DevExpressLoadResultDto<IEnumerable<CustomTicketDto>>>(Errors.General.GeneralServerError(), null);
            }
        }
        ...
        public async Task<Tuple<Error, CustomTicketDto>> GetTicketWrapperWithStatusByIdAsync(int Id)
        {
            if (businessLogicContainerStatus)
            {
                switch (_applicationBusinessLogicEnvironment)
                    ...
                    case ApplicationBusinessLogicEnvironment.Development:
                        {
                            ...
                            return await businessRule.GetTicketWrapperWithStatusByTicketIdAsync(Id);
                        }
                    case ApplicationBusinessLogicEnvironment.Test:
                        {
                            return new Tuple<Error, CustomTicketDto>(Errors.General.NotFoundDatabaseServer(), null);
        ...
        public async Task<Tuple<Error, IEnumerable<CustomTicketDto>>> GetAllTicketWrapperWithLocationFilterNonWebAsync(BusinessLogicRequest request)
        {
            if (businessLogicContainerStatus)
            {
                switch (_applicationBusinessLogicEnvironment)
                    ...
                    case ApplicationBusinessLogicEnvironment.Development:
                        {
                            ...
                            return await businessRule.GetAllTicketWrapperWithLocationFilterNonWebAsync(request);
                        }
                    case ApplicationBusinessLogicEnvironment.Test:
                        {
                            return new Tuple<Error, IEnumerable<CustomTicketDto>>(Errors.General.NotFoundDatabaseServer(), null);
        ...
        public async Task<Tuple<Error, IEnumerable<CustomTicketDto>>> GetAllTicketWrapperWithTowerFilterNonWebAsync(BusinessLogicRequest request)
        {
            if (businessLogicContainerStatus)
            {
                switch (_applicationBusinessLogicEnvironment)
                    ...
                    case ApplicationBusinessLogicEnvironment.Development:
                        {
                            ...
                            return await businessRule.GetAllTicketWrapperWithTowerFilterNonWebAsync(request);
                        }
                    case ApplicationBusinessLogicEnvironment.Test:
                        {
                            return new Tuple<Error, IEnumerable<CustomTicketDto>>(Errors.General.NotFoundDatabaseServer(), null);
