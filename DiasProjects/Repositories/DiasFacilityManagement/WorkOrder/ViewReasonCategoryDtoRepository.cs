...
{
    public class ViewReasonCategoryDtoRepository : IViewReasonCategoryDtoRepository
    {
        private IBaseViewReasonCategoryBusinessRules _baseViewReasonCategoryBusinessRules;
        ...
        public ViewReasonCategoryDtoRepository(IBaseViewReasonCategoryBusinessRules baseViewReasonCategoryBusinessRules, ApplicationBusinessLogicEnvironment applicationBusinessLogicEnvironment)
        {
            businessLogicContainerStatus = SimpleInjectorContainerOperations.VerifyContainer();

            if (businessLogicContainerStatus)
            {
                _baseViewReasonCategoryBusinessRules = baseViewReasonCategoryBusinessRules;
