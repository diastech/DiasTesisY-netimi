...
namespace DiasWebApi.Repositories.DiasFacilityManagement
{
    public class BasicTicketWrapperDtoRepository : IBasicTicketWrapperDtoRepository
    {
        ...
        #region Development
        public async Task<Tuple<Error, IEnumerable<CustomBasicTicketDto>>> GetAllBasicTicketsWrapperAsync(DevExpressRequest devExpressRequestObj)
        {
            if (businessLogicContainerStatus)
            {
                switch (_applicationBusinessLogicEnvironment)
                {
                    ...
                    case ApplicationBusinessLogicEnvironment.Test:
                        {                            
                            return new Tuple<Error, IEnumerable<CustomBasicTicketDto>>(Errors.General.NotFoundDatabaseServer(), null);
                        }
            ...
            {
                return new Tuple<Error, IEnumerable<CustomBasicTicketDto>>(Errors.General.GeneralServerError(), null);
            }
        }
