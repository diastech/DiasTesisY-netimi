                    ...
                    case ApplicationBusinessLogicEnvironment.Development:
                        {
                            ...
                            Tuple<Error, UserDto> businessResult =  await _genericStandartBusinessRules.InsertV2(insertedDto, uniqueColumns, uniqueValues);

                            //cachi temizle
                            if(businessResult.Item1.BusinessOperationSucceed)
                            {
                                RedisCacheOperationExtensions k = new RedisCacheOperationExtensions("127.0.0.1:6379", "*User*");
                            }
                    ...
                    case ApplicationBusinessLogicEnvironment.Development:
                        {
                            ...
                            Tuple<Error, UserDto> businessResult = await _genericStandartBusinessRules.UpdateV2(updatedDto, uniqueColumns, uniqueValues, false);
                    ...
                    case ApplicationBusinessLogicEnvironment.Development:
                        {
                            ...
                            Tuple<Error, UserDto> businessResult = await businessRule.MakeUserActiveOrPassiveByUserIdAsync(userId, userStatusId);
