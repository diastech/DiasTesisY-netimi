...
namespace DiasWebApi.Shared.Configuration
{
    public static class ConfigurationHelper
    {
        ...
        //null döndürmez
        public static ApplicationNLogEnvironment GetNLogEnvironment(IConfiguration configSettings)
        {
            if (String.IsNullOrEmpty(configSettings["NLogEnvironment"]))
            {
                return ApplicationNLogEnvironment.Development;
            }

            try
            {
                return configSettings["NLogEnvironment"].GetValueFromDescription<ApplicationNLogEnvironment>();
            }
            catch (Exception)
            {
                return ApplicationNLogEnvironment.Development;
