...
{
    [ApiController]
    public class TicketNoteWrapperController : Controller
    {
        private readonly DFManagementStdDtoInterface.ITicketNoteWrapperDtoRepository _ticketNoteWrapperDtoRepository;

        public TicketNoteWrapperController(DFManagementStdDtoInterface.ITicketNoteWrapperDtoRepository ticketNoteWrapperDtoRepository)
        {
            _ticketNoteWrapperDtoRepository = ticketNoteWrapperDtoRepository;            
        }
                    ...
                    case ApplicationWorkingEnvironment.Development:
                        {
                            ...
                            Tuple<Error, IEnumerable<DFManagementCustomDto.CustomTicketNoteDto>> serviceResult =new(Errors.General.None(), new List<DFManagementCustomDto.CustomTicketNoteDto>());
                            ...
                            if (request != null)
                            {
                                switch (request.RequestDomain)
                                {
                                    case RemoteIncomingDomains.DiasTesisYonetimWebClient:
                                        {
                                            serviceResult = await _ticketNoteWrapperDtoRepository.GetTicketNoteByTicketIdAsync(id);

                                            BusinessLogicResponse returnResponse = ResponseOperationsCustomMulti<DFManagementCustomDto.CustomTicketNoteDto>.ConvertServiceResultToBusinessLogicResponse(
                    ...
                    case ApplicationWorkingEnvironment.Development:
                        {
                            ...
                            {
                                BusinessLogicResponse returnResponseClient = ResponseOperationsCustomSingle<DFManagementCustomDto.CustomTicketNoteDto>.
                            ...
                            Tuple<Error, DFManagementCustomDto.CustomTicketNoteDto> serviceResult =
                                    new(Errors.General.None(), new DFManagementCustomDto.CustomTicketNoteDto());
                            ...
                            if (request != null)
                            {
                                switch (request.RequestDomain)
                                {
                                    case RemoteIncomingDomains.DiasTesisYonetimWebClient:
                                        {
                                            serviceResult = await _ticketNoteWrapperDtoRepository.AddTicketNoteWrapperAsync(request);

                                            BusinessLogicResponse returnResponse = ResponseOperationsCustomSingle<DFManagementCustomDto.CustomTicketNoteDto>.ConvertServiceResultToBusinessLogicResponse(
                                                                new Tuple<Error, object>(serviceResult.Item1, (object)serviceResult.Item2));
                    ...
                    case ApplicationWorkingEnvironment.Development:
                        {
                            ...
                            if (request != null)
                            {
                                switch (request.RequestDomain)
                                {
                                    case RemoteIncomingDomains.DiasTesisYonetimWebClient:
                                        {
                                            serviceResult = await _ticketNoteWrapperDtoRepository.DeleteTicketNoteWrapperAsync(request);
