                            ...
                            if (request != null)
                            {
                                ...
                                switch (request.RequestDomain)
                                {
                                    case RemoteIncomingDomains.DiasTesisYonetimWebClient:
                                        {
                                            Tuple<Error, DevExpressLoadResultDto<IEnumerable<DFManagementCustomDto.CustomPeriodicTicketDto>>> serviceResult = await _periodicTicketWrapperDtoRepository.GetAllPeriodicTicketsWrapperAsync(request.DevExpressRequestObj);
