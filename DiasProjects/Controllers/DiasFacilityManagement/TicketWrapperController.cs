...
namespace DiasWebApi.DiasFacilityManagement.Controllers
{
    ...
    public class TicketWrapperController : Controller
    {
        ...
        public async Task<BusinessLogicResponse> GetAllTicketWrapperAsync([FromBody] BusinessLogicRequest request = null)
        {
            try
            {
                      ...
                      (request.DevExpressRequestObj.RequestOptions != null) &&
                       ...
                       (((request.DevExpressRequestObj.RequestOptions.DataSourceLoadOption.Filter != null) && 
                         (request.DevExpressRequestObj.RequestOptions.DataSourceLoadOption.Filter.Count > 0)) ||
                           (request.DevExpressRequestObj.RequestOptions.DataSourceLoadOption.Take > 0)) &&
                             (!(String.IsNullOrEmpty(request.DevExpressRequestObj.AdditionalDevExpressParamJson))))
                {
                    ...
                    request.DevExpressRequestObj.RequestOptions.DataSourceLoadOption.Take = serializedFilter.Take;
                    request.DevExpressRequestObj.RequestOptions.DataSourceLoadOption.Skip = serializedFilter.Skip;
                }
                    ...
                    case ApplicationWorkingEnvironment.Development:
                        {
                            ...
                            Tuple<Error, DevExpressLoadResultDto<IEnumerable<DFManagementCustomDto.CustomTicketDto>>> serviceResult =new(Errors.General.None(), new());
                            Tuple<Error, IEnumerable<DFManagementCustomDto.CustomTicketDto>> serviceResultMobile = new(Errors.General.None(), new List<DFManagementCustomDto.CustomTicketDto>());
                                ...
                                switch (request.RequestDomain) 
                                {
                                    case RemoteIncomingDomains.DiasTesisYonetimWebClient:
                                        {                                         
                                            ...
                                            serviceResult = await _ticketWrapperDtoRepository.GetAllTicketWrapperAsync(request.DevExpressRequestObj,request.jwt);                                           
                                            ...
                                            BusinessLogicResponse returnResponse = ResponseOperationsCustomMulti<DFManagementCustomDto.CustomTicketDto>.ConvertServiceResultToBusinessLogicResponse(
                                                                    new Tuple<Error, object>(serviceResult.Item1, (object)serviceResult.Item2.ResultDto));

                                            returnResponse.DevExpressFilteredAndOrPaginatedResultMetadata = serviceResult.Item2.LoadResultObj;
                                    ...
                                    case RemoteIncomingDomains.DiasTesisYonetimMobileClient:
                                        {
                                            serviceResultMobile = await _ticketWrapperDtoRepository.GetAllTicketWrapperMobileAsync(request.DevExpressRequestObj);
                                            BusinessLogicResponse returnResponse = ResponseOperationsCustomMulti<DFManagementCustomDto.CustomTicketDto>.ConvertServiceResultToBusinessLogicResponse(
                                                                    new Tuple<Error, object>(serviceResultMobile.Item1, (object)serviceResultMobile.Item2));

                                            returnResponse.OptionalJsonResult = JsonConvert.SerializeObject(serviceResultMobile.Item2, jsonSettings);
        ...
        /// <returns></returns>
        [Route("[controller]/GetAllWithLocationFilterNonWeb")]
        [HttpPost]
        public async Task<BusinessLogicResponse> GetAllTicketWrapperWithLocationFilterNonWebAsync([FromBody] BusinessLogicRequest request = null)
        {
            try
            {                
                IConfiguration settings = ConfigurationHelper.GetConfig();
                    ...
                    case ApplicationWorkingEnvironment.Development:
                        {
                            ...
                            Tuple<Error, IEnumerable<DFManagementCustomDto.CustomTicketDto>> serviceResultNonWeb = new(Errors.General.None(), new List<DFManagementCustomDto.CustomTicketDto>());
                            ...
                            if (request != null)
                            {
                                switch (request.RequestDomain)
                                {
                                    ...
                                    case RemoteIncomingDomains.DiasTesisYonetimMobileClient:
                                        {
                                            serviceResultNonWeb = await _ticketWrapperDtoRepository.GetAllTicketWrapperWithLocationFilterNonWebAsync(request);
                                            BusinessLogicResponse returnResponse = ResponseOperationsCustomMulti<DFManagementCustomDto.CustomTicketDto>.ConvertServiceResultToBusinessLogicResponse(
                                                                    new Tuple<Error, object>(serviceResultNonWeb.Item1, (object)serviceResultNonWeb.Item2));

                                            returnResponse.OptionalJsonResult = JsonConvert.SerializeObject(serviceResultNonWeb.Item2, jsonSettings);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        [Route("[controller]/GetAllWithTowerFilterNonWeb")]
        [HttpPost]
        public async Task<BusinessLogicResponse> GetAllTicketWrapperWithTowerFilterNonWebAsync([FromBody] BusinessLogicRequest request = null)
        {
            try
            {
                IConfiguration settings = ConfigurationHelper.GetConfig();
                    ...
                    case ApplicationWorkingEnvironment.Development:
                        {
                            ...
                            if (request != null)
                            {
                                switch (request.RequestDomain)
                                {
                                    ...
                                    case RemoteIncomingDomains.DiasTesisYonetimMobileClient:
                                        {
                                            serviceResultNonWeb = await _ticketWrapperDtoRepository.GetAllTicketWrapperWithTowerFilterNonWebAsync(request);
                                            BusinessLogicResponse returnResponse = ResponseOperationsCustomMulti<DFManagementCustomDto.CustomTicketDto>.ConvertServiceResultToBusinessLogicResponse(
                                                                    new Tuple<Error, object>(serviceResultNonWeb.Item1, (object)serviceResultNonWeb.Item2));
        ...
        [Route("[controller]/GetByWithStatusId/{id}")]
        [HttpPost]
        public async Task<BusinessLogicResponse> GetTicketWrapperWithStatusByIdAsync(int id, [FromBody] BusinessLogicRequest request = null)
        {
            try
            {
                IConfiguration settings = ConfigurationHelper.GetConfig();
                    ...
                    case ApplicationWorkingEnvironment.Development:
                        {
                            ...
                            if (request != null)
                            {
                                switch (request.RequestDomain)
                                {
                                    case RemoteIncomingDomains.DiasTesisYonetimWebClient:
                                        {
                                            serviceResult = await _ticketWrapperDtoRepository.GetTicketWrapperWithStatusByIdAsync(id);
                                    ...
                                    case RemoteIncomingDomains.DiasTesisYonetimMobileClient:
                                        {
                                            ...
                                            returnResponse.OptionalJsonResult = JsonConvert.SerializeObject(serviceResultMobile.Item2);
                                    ...
                                    case RemoteIncomingDomains.DiasTesisYonetimMobileClient:
                                        {
                                            ...
                                            BusinessLogicResponse returnResponse = ResponseOperationsCustomSingleTest<DFManagementCustomTestDto.CustomMobileTicketDto>.ConvertServiceResultToBusinessLogicResponse(
                                                                new Tuple<ErrorCodes, object>(serviceResultMobile.Item1, (object)serviceResultMobile.Item2));
