...
namespace DiasWebApi.InterfacesAbstracts.Interfaces.Repositories.DiasFacilityManagement
{
    ...
    {
        #region Development
        public Task<Tuple<Error, DevExpressLoadResultDto<IEnumerable<CustomDto.CustomTicketDto>>>> GetAllTicketWrapperAsync(DevExpressRequest devExpressRequestObj,string token);
        ...
        public Task<Tuple<Error, IEnumerable<CustomTicketDto>>> GetAllTicketWrapperWithLocationFilterNonWebAsync(BusinessLogicRequest request);
        public Task<Tuple<Error, IEnumerable<CustomTicketDto>>> GetAllTicketWrapperWithTowerFilterNonWebAsync(BusinessLogicRequest request);
        ...
        public Task<Tuple<Error, CustomDto.CustomTicketDto>> GetTicketWrapperWithStatusByIdAsync(int Id);
