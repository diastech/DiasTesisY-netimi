...
namespace DiasWebApi.InterfacesAbstracts.Interfaces.Repositories.DiasFacilityManagement
{
    ...
    {
        public Task<Tuple<Error, IEnumerable<DevelopmentDto.AssignmentGroupEmployeeDto>>> GetAllAsync();
        public Task<Tuple<Error, IEnumerable<DevelopmentDto.AssignmentGroupEmployeeDto>>> GetUsersByGroupIdAsync(int groupId);
