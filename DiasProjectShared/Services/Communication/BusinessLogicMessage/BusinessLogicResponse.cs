...
namespace DiasShared.Services.Communication.BusinessLogicMessage
{
    public class BusinessLogicResponse
    {
        ...
        //ihtiyaç olmadıkça kullanılmayacak(clientdan gelen DataSourceLoadOptions kullanılacak)
        public DataSourceLoadOptions DevExpressLoadOptions { get; set; }

        //Dönen listenin veritabanındaki toplam satır sayısı vb. bilgiler
        //Kesinlikle datayı içermez, data RelevantDto ile dönecektir
        public LoadResult DevExpressFilteredAndOrPaginatedResultMetadata { get; set; }
        ...
        public BusinessLogicResponse(object relevantDto, HttpResponseCodes httpResponseCode, Error crudErrorCode,
           bool operationResult, string optionalJsonResult = null, string additionalInfo = null, string jwtToken = null,
           DataSourceLoadOptions devExtremeLoadOpt = null, LoadResult devExtremeDataMetadata = null)
        {
            RelevantDto = relevantDto;
            HttpResponseCode = httpResponseCode;
            ...
            AdditionalInfo = additionalInfo;
            JwtTokenStr = jwtToken;
            DevExpressLoadOptions = devExtremeLoadOpt;
            DevExpressFilteredAndOrPaginatedResultMetadata = devExtremeDataMetadata;
