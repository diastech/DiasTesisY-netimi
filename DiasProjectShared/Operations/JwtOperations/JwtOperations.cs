...
namespace DiasShared.Operations.JwtOperation
{
    public static class JwtOperations
    {
        ...
        public static string ProduceNewJwtToken(string tokenIdentifier, int userId,  IList<Claim> companyRoleClaims = null)
        {
            ...
            addedClaims.Add(new Claim(ClaimTypes.NameIdentifier, userId.ToString()));
