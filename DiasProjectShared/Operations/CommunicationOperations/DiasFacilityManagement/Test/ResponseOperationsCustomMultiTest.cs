...
{
    /// <summary>
    /// Custom, IEnumerable(list) Dto içeren request response kalıbı
    /// </summary>
    /// <typeparam name="TDto">Dto sınıfı, standart olmak zorunda</typeparam>
    public static class ResponseOperationsCustomMultiTest<TDto> where TDto : IBaseDevelopmentCustomDto
    {
