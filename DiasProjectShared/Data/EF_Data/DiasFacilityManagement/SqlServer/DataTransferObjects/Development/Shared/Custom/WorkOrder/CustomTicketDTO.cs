...
namespace DiasShared.Data.EF_Data.DiasFacilityManagement.SqlServer.DataTransferObjects.Development.Shared.Custom
{
    public class CustomTicketDto : TicketDto, IBaseDevelopmentCustomDto
    {
        ...
        public string DateTimeResolutionedTimeString { get; set; }
        public string DateTimeResponsedTimeString { get; set; }


        public string TicketAssignedGrupString { get; set; }
        ...
        public List<List<LocationItemDto>> LocationItems { get; set; }
    }
}
