...
namespace DiasShared.Data.EF_Data.DiasFacilityManagement.SqlServer.DataTransferObjects.Development.Shared.Standard
{
    public class TicketDto : BaseDevelopmentStandartDto
    {
        ...
        public int? LocationCodeId {
            ...
            set
            {
                int v2 = value ?? 1;//Varsayılan BSHTY
        ...
        public string LocationNameGetByCodeId = 1.GetEnumValue<LocationCodeEnum>().GetDisplayOrValueFromEnum<LocationCodeEnum>();//Varsayılan BSHTY
        ...
        public string TicketAssignedUserName { get; set; }
        public string TicketAssignedUserLastName { get; set; }
