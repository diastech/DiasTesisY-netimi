...
namespace DiasShared.Enums.Standart
{
    public class AuthorizationEnums
    {
        ...
        /// <summary>
        /// Description -> Tanım, Display -> 64'lük parça indeksi, Enum Sayı -> Yetki Kodu
        /// </summary>
        [Flags]
        ...
        [Flags]
        public enum WebTicketPageDefinitions : long
        {
            [Description("Vaka Numarası")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketCode = 1,
            ...
            [Description("Vaka Nedeni")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketReason = 4,

            [Description("Müdahale Süresi")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketOperationTime = 8,

            [Description("Çözüm Süresi")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketResolveTime = 16,

            [Description("Bildirim Zamanı")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketAnnounceTime = 32,

            [Description("Hedeflenen Müdahale Zamanı")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TargetedOperationTime = 64,
           
            [Description("Hedeflenen Çözüm Zamanı")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TargetedResolveTime = 128,

            [Description("Bildiren Kişi Ad Soyad")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketReportUserNameSurname = 256,

            [Description("Bildiren Kişi Telefon")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketReportUserPhone = 512,

            [Description("Ekleyen Kişi Ad Soyad")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketAddUserNameSurname = 1024,

            [Description("Ekleyen Kişi Telefon")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketAddUserPhone = 2048,

            [Description("Atanan Kişi/Grup Ad")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketAssignedUserOrGroupName = 4096,           

            [Description("Atama Grubu")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketAssignmentGroup = 8192,

            [Description("İş Emri Öncelik")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketPriority = 16384,

            [Description("Vaka Mahali")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketLocation = 32768L,

            [Description("İş Emri Müdahale Edilme Zamanı")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketOperationStartTime = 65536L,

            [Description("İş EmriÇözüm Zamanı")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketResolvedTime = 131072L,

            [Description("İş Emri Kapatılma Zamanı")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketClosedTime = 262144L,

            [Description("İş Emri Eklenme Zamanı")]
            [Display(Name = "MenuHierarchicalLevel1")]
            TicketAddedTime = 524288L
        }
    }
}
