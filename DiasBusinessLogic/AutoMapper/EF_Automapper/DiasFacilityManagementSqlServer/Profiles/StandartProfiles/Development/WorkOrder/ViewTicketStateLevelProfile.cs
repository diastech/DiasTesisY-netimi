...
{
    public class ViewTicketStateLevelProfile : Profile
    {
        public ViewTicketStateLevelProfile(Type dataContextType)
        {
            switch (dataContextType.Name)
            {
                case "DiasFacilityManagementSqlServer":
                    {
                        CreateMap<Model.VwTicketStateLevel, Dto.ViewTicketStateLevelDto>();

                        CreateMap<Dto.ViewTicketStateLevelDto, Model.VwTicketStateLevel>();
