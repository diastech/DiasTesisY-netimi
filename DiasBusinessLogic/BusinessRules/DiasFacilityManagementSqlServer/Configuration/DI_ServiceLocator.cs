    ...
    public class DI_ServiceLocator
    {
        ...
        private sealed class DefaultServiceLocator_Live : IDI_ServiceLocator
        {
            ...
            private void LoadInstanceBindings()
            {
                ...
                container.Register<DevFmBlInterface.IGenericStandartBusinessRules<DevFmStanDto.FacilityDto, DevFmMapProf.FacilityProfile>,
                   GenFMDev.GenericStandartBusinessRules<DevFmStanDto.FacilityDto, DevFmMapProf.FacilityProfile>>(Lifestyle.Scoped);

                container.Register<DevFmBlInterface.IGenericStandartBusinessRules<DevFmStanDto.AssignmentGroupDto, DevFmMapProf.AssignmentGroupProfile>,
                   GenFMDev.GenericStandartBusinessRules<DevFmStanDto.AssignmentGroupDto, DevFmMapProf.AssignmentGroupProfile>>(Lifestyle.Scoped);
