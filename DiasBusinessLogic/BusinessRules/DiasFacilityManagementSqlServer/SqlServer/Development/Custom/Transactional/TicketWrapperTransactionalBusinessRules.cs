                                        ...
                                        if ((updatedTicket.Item1.BusinessOperationSucceed == true) && (updatedTicket.Item2 != null))
                                        {
                                            ...
                                            {                                               
                                                ...
                                                {                                                    
                                                    ...
                                                    attachmentDto.AttachmentDescription = "Mobil Attachment";
                                                    FileInfo fi = new FileInfo(attachmentItem.FileName);

                                                    attachmentItem.FileName = "Ticket_" + resultAddedTicket.Item2.Id.ToString() +
                                                                               "_Added_" + resultAddedTicket.Item2.AddedByUserId.ToString() +
