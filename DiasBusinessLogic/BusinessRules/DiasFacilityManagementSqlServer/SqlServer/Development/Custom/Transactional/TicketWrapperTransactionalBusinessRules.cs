                    ...
                    case "DiasFacilityManagementSqlServer":
                        {
                            ...
                            using (IDbContextTransaction transaction = DiasFacilityManagementSqlServerContext.Database.BeginTransaction())
                            {
                                try
                                {
                                    ...
                                    if((resultGetTicket.Item1.BusinessOperationSucceed) && (resultGetTicket.Item2 != null))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            //return new Tuple<Error, CustomTicketDto>(Errors.General.ErrorExceptionError("Ticket", resultAddedTicket.Item1.Message), null);
                                ...
                                catch (Exception e)
                                {
                                    ...
                                    //return new Tuple<Error, CustomTicketDto>(Errors.General.ErrorExceptionError("Ticket", e.Message), null);
                                }
                            }
                        }
                            ...
                            using (IDbContextTransaction transaction = DiasFacilityManagementSqlServerContext.Database.BeginTransaction())
                            {
                                try
                                {
                                    ...
                                    if ((resultAddedTicket.Item1.BusinessOperationSucceed == true) && (resultAddedTicket.Item2 != null))
                                    {
                                        ...
                                        var ticketCode = resultAddedTicket.Item2.LocationNameGetByCodeId + sonuc + resultAddedTicket.Item2.Id.ToString();
