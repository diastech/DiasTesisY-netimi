                    ...
                    case "DiasFacilityManagementSqlServer":
                        {
                            ...
                            try
                            {
                                if ((resultGetUserList.Item1.BusinessOperationSucceed == true) && (resultGetUserList.Item2 != null))
                                {
                                    ...
                                    {
                                        Tuple<Error, IEnumerable<DevelopmentDto.AssignmentGroupEmployeeDto>> resultGetAssignmentGroupEmployeeList = await _assignmentGroupEmployeeBusinessRules.GetAssignmentGroupEmployeeListAsync();
