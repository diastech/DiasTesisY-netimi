...
namespace DiasBusinessLogic.InterfacesAbstracts.Interfaces.BusinessRules.DiasFacilityManagementSqlServer.SqlServer.Development.Custom
{
    ...
    {
        public Task<Tuple<Error, DevExpressLoadResultDto<IEnumerable<CustomDto.CustomBasicTicketDto>>>> GetAllBasicTicketsWrapperAsync(DevExpressRequest devExpressRequestObj);
