...
{
    public partial class DiasFacilityManagementSqlServer : DbContext
    {
        public DiasFacilityManagementSqlServer()
        {
        }

        public DiasFacilityManagementSqlServer(DbContextOptions<DiasFacilityManagementSqlServer> options)
            : base(options)
        {
        }
