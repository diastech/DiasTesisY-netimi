...
namespace DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFM.SqlServer.Development.StaticDatabaseContext
{
    public static class IdentityManagement_DFMTemplateSqlServerInitializer
    {
        public static void InitializeAndSeedData()
        {
            using (var context = new IdentityManagement_DFMSqlServer())
            {
        ...
        private static void InitializeCompanyRoles(IdentityManagement_DFMSqlServer context)
        {
