...
{
    public class CompanyRoleUser : IdentityUserRole<int>, IDevelopmentBaseEntity //C# iki classtan türetmeye izin vermediği için IDevelopmentBaseEntity kullanıyoruz
    {
