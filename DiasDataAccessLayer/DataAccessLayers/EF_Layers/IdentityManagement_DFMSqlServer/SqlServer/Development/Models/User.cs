...
namespace DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFM.SqlServer.Development.Models
{
    ...
    [Index(nameof(Email), IsUnique = true, Name = "Index_Unique_Clustered_User_Email")]
    public class User : IdentityUser<int>, IDevelopmentBaseEntity //C# iki classtan türetmeye izin vermediği için IDevelopmentBaseEntity kullanıyoruz
    {
        public User()
        {
            ...
            BasicTicketReportedByUsers = new HashSet<BasicTicket>();
            FacilityAddedByUsers = new HashSet<Facility>();
            FacilityLastModifiedByUsers = new HashSet<Facility>();
        }
        ...
        public virtual ICollection<BasicTicket> BasicTicketReportedByUsers { get; set; }
        public virtual ICollection<Facility> FacilityAddedByUsers { get; set; }
        public virtual ICollection<Facility> FacilityLastModifiedByUsers { get; set; }
