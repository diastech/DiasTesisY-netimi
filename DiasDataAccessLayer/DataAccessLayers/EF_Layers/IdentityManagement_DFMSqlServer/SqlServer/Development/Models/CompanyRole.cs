...
namespace DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFM.SqlServer.Development.Models
{
    ...
    {    
        public CompanyRole()
        {
            ParentCompanyRolesAddedByRoles = new HashSet<CompanyRole>();
        }
        ...
        public virtual CompanyRole ParentCompanyRole { get; set; }

        public virtual ICollection<CompanyRole> ParentCompanyRolesAddedByRoles { get; set; }
    }
}
