...
namespace DiasDataAccessLayer.Migrations.DiasFacilityManagement.SqlServer.Development
{
    ...
    [Migration("20220510132249_AddUserTableAddColumnTurkishRepublicIdNumber")]
    partial class AddUserTableAddColumnTurkishRepublicIdNumber
    {
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.DiasFacilityManagement.SqlServer.Development.Models.LocationV2", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("HierarchyId"), false);

                    b.HasIndex("LastModifiedByUserId");

                    b.HasIndex(new[] { "HierarchyId" }, "Index_Unique_Clustered_LocationV2_HierarchyId")
                        .IsUnique();
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.DiasFacilityManagement.SqlServer.Development.Models.Ticket", b =>
                {
                    ...
                    b.Property<string>("TicketReportedUserNameSurname")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TicketReportedUserPhone")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.DiasFacilityManagement.SqlServer.Development.Models.TicketReasonCategoryV2", b =>
                {
                    ...
                    b.HasIndex(new[] { "HierarchyId" }, "Index_Unique_Clustered_TicketReasonCategoryV2_HierarchyId")
                        .IsUnique();
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFM.SqlServer.Development.Models.CompanyRoleClaim", b =>
                {
                    ...
                    b.ToTable("CompanyRoleClaim", "idn");
                });
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFM.SqlServer.Development.Models.User", b =>
                {
                    ...
                    b.Property<string>("TurkishRepublicIdNumber")
                    ...
                    b.HasIndex(new[] { "Email" }, "Index_Unique_Clustered_User_Email")
                        .IsUnique()
                        .HasFilter("[Email] IS NOT NULL");
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.DiasFacilityManagement.SqlServer.Development.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("DiasDataAccessLayer.DataAccessLayers.EF_Layers.DiasFacilityManagement.SqlServer.Development.Models.Facility", "FacilityByUser")
                        .WithMany("TicketAddedByUsers")
