...
namespace DiasDataAccessLayer.Migrations.DiasFacilityManagementTemplate.SqlServer.Development
{
    ...
    partial class DiasFacilityManagementTemplateSqlServerModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.CompanyRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.DiasFacilityManagementTemplate.SqlServer.Development.Models.AssignmentGroup", b =>
                {
                    b.HasOne("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.User", "AddedByUser")
                        .WithMany("AssignmentGroupAddedByUsers")
                        .HasForeignKey("AddedByUserId")
                        .HasConstraintName("FK_AssignmentGroup_AddedByUserId_User_Id")
                        .IsRequired();

                    b.HasOne("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.User", "GroupManagerUser")
                        .WithMany("AssignmentGroupGroupManagerUsers")
                        .HasForeignKey("GroupManagerUserId")
                        .HasConstraintName("FK_assignmentgroup_hr")
                        .IsRequired();

                    b.HasOne("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.User", "LastModifiedByUser")
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.DiasFacilityManagementTemplate.SqlServer.Development.Models.AssignmentGroupEmployee", b =>
                {
                    ...
                    b.HasOne("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.User", "EmployeeUser")
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.DiasFacilityManagementTemplate.SqlServer.Development.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.User", "TicketAssignedUser")
            ...
            modelBuilder.Entity("DiasDataAccessLayer.DataAccessLayers.EF_Layers.DiasFacilityManagementTemplate.SqlServer.Development.Models.TicketAuditHistory", b =>
                {
                    ...
                    b.HasOne("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.User", "NextTicketAssignedUser")
                    ...
                    b.HasOne("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.User", "PreviousTicketAssignedUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.CompanyRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("DiasDataAccessLayer.DataAccessLayers.EF_Layers.IdentityManagement_DFMTemplate.SqlServer.Development.Models.User", null)
                        .WithMany()
